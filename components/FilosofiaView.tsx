        ...
        <section className="space-y-16">
          {items.map((item, index) => (
            <div key={index} className="group">
              <div className="flex items-center gap-2 xs:gap-3 xs:gap-4 mb-6 xs:mb-8">
                <span className="text-[6px] xs:text-[8px] sm:text-[10px] font-black font-mono text-neutral-700 tracking-[0.5em]">0{index + 1}</span>
                <div className="h-[1px] flex-1 bg-neutral-900" />
                <span className="text-[6px] xs:text-[8px] sm:text-[10px] font-black uppercase tracking-[0.6em] text-neutral-600">{item.category}</span>
              </div>
              
              <div className="bg-neutral-900/50 border border-neutral-800 rounded-lg p-4 xs:p-6 sm:p-8 md:p-12 hover:bg-neutral-900/70 transition-all duration-300">
                <div className="flex flex-col sm:flex-row items-start gap-4 xs:gap-6 space-y-6 xs:space-y-8">
                  {/* Ícone Pulsante */}
                  <div className="flex-shrink-0">
                    {item.title === "CLAREZA" && (
                      <div className="relative">
                        <div className="absolute inset-0 bg-[#FFEE00] rounded-full opacity-20 animate-ping"></div>
                        <div className="relative w-12 xs:w-14 sm:w-16 h-12 xs:h-14 sm:h-16 bg-[#FFEE00]/10 rounded-full flex items-center justify-center border-2 border-[#FFEE00]/30">
                          <svg className="w-4 xs:w-6 sm:w-8 text-[#FFEE00]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    {item.title === "ESTRATÉGIA" && (
                      <div className="relative">
                        ...
                        <div className="relative w-12 xs:w-14 sm:w-16 h-12 xs:h-14 sm:h-16 bg-[#58B573]/10 rounded-full flex items-center justify-center border-2 border-[#58B573]/30">
                          <svg className="w-4 xs:w-6 sm:w-8 text-[#58B573]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    {item.title === "SIMPLES" && (
                      <div className="relative">
                        ...
                        <div className="relative w-12 xs:w-14 sm:w-16 h-12 xs:h-14 sm:h-16 bg-blue-500/10 rounded-full flex items-center justify-center border-2 border-blue-500/30">
                          <svg className="w-4 xs:w-6 sm:w-8 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    {item.title === "DADOS" && (
                      <div className="relative">
                        ...
                        <div className="relative w-12 xs:w-14 sm:w-16 h-12 xs:h-14 sm:h-16 bg-purple-500/10 rounded-full flex items-center justify-center border-2 border-purple-500/30">
                          <svg className="w-4 xs:w-6 sm:w-8 text-purple-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    {item.title === "PROPÓSITO" && (
                      <div className="relative">
                        ...
                        <div className="relative w-12 xs:w-14 sm:w-16 h-12 xs:h-14 sm:h-16 bg-red-500/10 rounded-full flex items-center justify-center border-2 border-red-500/30">
                          <svg className="w-4 xs:w-6 sm:w-8 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    {item.title === "DIREÇÃO" && (
                      <div className="relative">
                        ...
                        <div className="relative w-12 xs:w-14 sm:w-16 h-12 xs:h-14 sm:h-16 bg-orange-500/10 rounded-full flex items-center justify-center border-2 border-orange-500/30">
                          <svg className="w-4 xs:w-6 sm:w-8 text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="flex-1 space-y-4 xs:space-y-6">
                    <h2 className={`text-xl xs:text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black uppercase tracking-tighter transition-colors ${
                    ...
                    <div className="space-y-3 xs:space-y-4 text-sm xs:text-base sm:text-lg lg:text-xl text-neutral-400 leading-relaxed font-medium">
                      {item.title === "CLAREZA" && (
                        <>
