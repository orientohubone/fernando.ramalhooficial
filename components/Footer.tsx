        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-16">
          <div className="max-w-2xl flex flex-col gap-6">
            ...
            <div className="flex flex-wrap gap-8 items-center mt-2">
              <a href="mailto:fernandoluizsouzaramalho@gmail.com" className="text-base md:text-lg font-black uppercase tracking-widest border-b-2 border-[#FFEE00] pb-1 hover:bg-[#FFEE00] hover:text-black transition-all">
